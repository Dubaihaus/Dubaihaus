// src/components/legal/LegalClient.jsx
"use client";
...
export default function LegalClient() {
  ...
  const title = useMemo(
    () => `${tab === "privacy" ? "Privacy Policy" : "Terms & Conditions"} | DubaiHaus`,
    [tab]
  );
  ...
  // Optionally keep the document title in sync for UX (not SEO-critical)
  useEffect(() => {
      ...
      <section className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
          ...
          <div className="p-6 sm:p-8">
            {tab === "privacy" ? <PrivacyPolicy lang={lang} /> : <Terms lang={lang} />}
          </div>
